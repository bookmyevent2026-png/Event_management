...
function Divider({ children }) {
  return (0, import_jsx_runtime2.jsx)("span", { className: "react-time-picker__inputGroup__divider", children });
}
...
function AmPm({ ariaLabel, autoFocus, className, disabled, inputRef, locale, maxTime, minTime, onChange, onKeyDown, required, value }) {
  ...
  return (0, import_jsx_runtime3.jsxs)("select", {
    ...
    children: [!value && (0, import_jsx_runtime3.jsx)("option", { value: "", children: "--" }), (0, import_jsx_runtime3.jsx)("option", { disabled: amDisabled, value: "am", children: amLabel }), (0, import_jsx_runtime3.jsx)("option", { disabled: pmDisabled, value: "pm", children: pmLabel })]
  });
}
...
function Input({ ariaLabel, autoFocus, className, disabled, inputRef, max, min, name, nameForClass, onChange, onKeyDown, onKeyUp, placeholder = "--", required, showLeadingZeros, step, value }) {
  ...
  return (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [hasLeadingZero ? (0, import_jsx_runtime4.jsx)("span", { className: `${className}__leadingZero`, children: "0" }) : null, (0, import_jsx_runtime4.jsx)("input", {
    "aria-label": ariaLabel,
    autoComplete: "off",
    // biome-ignore lint/a11y/noAutofocus: This is up to developers' decision
    autoFocus,
...
function Hour12Input({ amPm, maxTime, minTime, value, ...otherProps }) {
  ...
  return (0, import_jsx_runtime5.jsx)(Input, { max: maxHour, min: minHour, name: "hour12", nameForClass: "hour", value: value12, ...otherProps });
}
...
function Hour24Input({ maxTime, minTime, ...otherProps }) {
  ...
  return (0, import_jsx_runtime6.jsx)(Input, { max: maxHour, min: minHour, name: "hour24", nameForClass: "hour", ...otherProps });
}
...
function MinuteInput({ hour, maxTime, minTime, showLeadingZeros = true, ...otherProps }) {
  ...
  return (0, import_jsx_runtime7.jsx)(Input, { max: maxMinute, min: minMinute, name: "minute", showLeadingZeros, ...otherProps });
}
...
function NativeInput({ ariaLabel, disabled, maxTime, minTime, name, onChange, required, value, valueType }) {
  ...
  return (0, import_jsx_runtime8.jsx)("input", { "aria-label": ariaLabel, disabled, hidden: true, max: maxTime ? nativeValueParser(maxTime) : void 0, min: minTime ? nativeValueParser(minTime) : void 0, name, onChange, onFocus: stopPropagation, required, step, style: {
    visibility: "hidden",
    position: "absolute",
    zIndex: "-999"
...
function SecondInput({ hour, maxTime, minTime, minute, showLeadingZeros = true, ...otherProps }) {
  ...
  return (0, import_jsx_runtime9.jsx)(Input, { max: maxSecond, min: minSecond, name: "second", showLeadingZeros, ...otherProps });
}
...
function renderCustomInputs(placeholder, elementFunctions, allowMultipleInstances) {
  ...
  return placeholder.split(pattern).reduce((arr, element, index) => {
    ...
    (0, import_jsx_runtime10.jsx)(Divider, { children: element }, `separator_${index}`);
    arr.push(divider);
...
function TimeInput({ amPmAriaLabel, autoFocus, className, disabled, format, hourAriaLabel, hourPlaceholder, isClockOpen: isClockOpenProps = null, locale, maxDetail = "minute", maxTime, minTime, minuteAriaLabel, minutePlaceholder, name = "time", nativeInputAriaLabel, onChange: onChangeProps, onInvalidChange, required, secondAriaLabel, secondPlaceholder, value: valueProps }) {
  const [amPm, setAmPm] = (0, import_react3.useState)(null);
  const [hour, setHour] = (0, import_react3.useState)(null);
  const [minute, setMinute] = (0, import_react3.useState)(null);
  const [second, setSecond] = (0, import_react3.useState)(null);
  const [value, setValue] = (0, import_react3.useState)(null);
  const amPmInput = (0, import_react3.useRef)(null);
  const hour12Input = (0, import_react3.useRef)(null);
  const hour24Input = (0, import_react3.useRef)(null);
  const minuteInput = (0, import_react3.useRef)(null);
  const secondInput = (0, import_react3.useRef)(null);
  const [isClockOpen, setIsClockOpen] = (0, import_react3.useState)(isClockOpenProps);
  ...
  function onChangeExternal() {
    ...
    if (isEveryValueFilled && isEveryValueValid) {
      ...
      const proposedValue = `${padStart(hour2)}:${padStart(minute2)}:${padStart(second2)}`;
  ...
  function renderHour12(currentMatch, index) {
    ...
    return (0, import_jsx_runtime10.jsx)(Hour12Input, { ...commonInputProps, amPm, ariaLabel: hourAriaLabel, autoFocus: index === 0 && autoFocus, inputRef: hour12Input, placeholder: hourPlaceholder, showLeadingZeros, value: hour }, "hour12");
  }
  function renderHour24(currentMatch, index) {
    ...
    const showLeadingZeros = currentMatch ? currentMatch.length === 2 : false;
    return (0, import_jsx_runtime10.jsx)(Hour24Input, { ...commonInputProps, ariaLabel: hourAriaLabel, autoFocus: index === 0 && autoFocus, inputRef: hour24Input, placeholder: hourPlaceholder, showLeadingZeros, value: hour }, "hour24");
  }
  ...
  function renderMinute(currentMatch, index) {
    ...
    const showLeadingZeros = currentMatch ? currentMatch.length === 2 : false;
    return (0, import_jsx_runtime10.jsx)(MinuteInput, { ...commonInputProps, ariaLabel: minuteAriaLabel, autoFocus: index === 0 && autoFocus, hour, inputRef: minuteInput, placeholder: minutePlaceholder, showLeadingZeros, value: minute }, "minute");
  }
  function renderSecond(currentMatch, index) {
    ...
    return (0, import_jsx_runtime10.jsx)(SecondInput, { ...commonInputProps, ariaLabel: secondAriaLabel, autoFocus: index === 0 && autoFocus, hour, inputRef: secondInput, minute, placeholder: secondPlaceholder, showLeadingZeros, value: second }, "second");
  }
  function renderAmPm(_currentMatch, index) {
    return (0, import_jsx_runtime10.jsx)(AmPm, { ...commonInputProps, ariaLabel: amPmAriaLabel, autoFocus: index === 0 && autoFocus, inputRef: amPmInput, locale, onChange, value: amPm }, "ampm");
  }
  ...
  function renderNativeInput() {
    return (0, import_jsx_runtime10.jsx)(NativeInput, { ariaLabel: nativeInputAriaLabel, disabled, maxTime, minTime, name, onChange: onChangeNative, required, value, valueType }, "time");
  }
  return (
    ...
    (0, import_jsx_runtime10.jsxs)("div", { className, onClick, children: [renderNativeInput(), renderCustomInputsInternal()] })
  );
}
...
var ClockIcon = (0, import_jsx_runtime11.jsxs)("svg", { ...iconProps, "aria-hidden": "true", className: `${baseClassName}__clock-button__icon ${baseClassName}__button__icon`, fill: "none", children: [(0, import_jsx_runtime11.jsx)("circle", { cx: "9.5", cy: "9.5", r: "7.5" }), (0, import_jsx_runtime11.jsx)("path", { d: "M9.5 4.5 v5 h4" })] });
var ClearIcon = (0, import_jsx_runtime11.jsxs)("svg", { ...iconProps, "aria-hidden": "true", className: `${baseClassName}__clear-button__icon ${baseClassName}__button__icon`, children: [(0, import_jsx_runtime11.jsx)("line", { x1: "4", x2: "15", y1: "4", y2: "15" }), (0, import_jsx_runtime11.jsx)("line", { x1: "15", x2: "4", y1: "4", y2: "15" })] });
function TimePicker(props) {
  ...
  const clockWrapper = (0, import_react4.useRef)(null);
  ...
  const closeClock = (0, import_react4.useCallback)(({ reason }) => {
    if (shouldCloseClock) {
  ...
  function renderInputs() {
    ...
    return (0, import_jsx_runtime11.jsxs)("div", { className: `${baseClassName}__wrapper`, children: [(0, import_jsx_runtime11.jsx)(TimeInput, { ...ariaLabelProps, ...placeholderProps, autoFocus, className: `${baseClassName}__inputGroup`, disabled, format, isClockOpen: isOpen, locale, maxDetail, maxTime, minTime, name, onChange, onInvalidChange, required, value: valueFrom }), clearIcon !== null && (0, import_jsx_runtime11.jsx)("button", { "aria-label": clearAriaLabel, className: `${baseClassName}__clear-button ${baseClassName}__button`, disabled, onClick: clear, onFocus: stopPropagation, type: "button", children: typeof clearIcon === "function" ? (0, import_react4.createElement)(clearIcon) : clearIcon }), clockIcon !== null && !disableClock && (0, import_jsx_runtime11.jsx)("button", { "aria-expanded": isOpen || false, "aria-label": clockAriaLabel, className: `${baseClassName}__clock-button ${baseClassName}__button`, disabled, onClick: toggleClock, onFocus: stopPropagation, type: "button", children: typeof clockIcon === "function" ? (0, import_react4.createElement)(clockIcon) : clockIcon })] });
  }
  function renderClock() {
    ...
    const clock = (0, import_jsx_runtime11.jsx)(dist_default2, { locale, value: valueFrom, ...clockProps });
    return portalContainer ? (0, import_react_dom.createPortal)((0, import_jsx_runtime11.jsx)("div", { ref: clockWrapper, className: classNames, children: clock }), portalContainer) : (0, import_jsx_runtime11.jsx)(dist_default3, { children: (0, import_jsx_runtime11.jsx)("div", { ref: (ref) => {
      if (ref && !isOpen) {
  ...
  return (
    ...
    (0, import_jsx_runtime11.jsxs)("div", { className: clsx_default(baseClassName, `${baseClassName}--${isOpen ? "open" : "closed"}`, `${baseClassName}--${disabled ? "disabled" : "enabled"}`, className), "data-testid": dataTestid, id, ...eventProps, onFocus: onFocus2, ref: wrapper, children: [renderInputs(), renderClock()] })
  );
}
