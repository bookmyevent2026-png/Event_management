  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 relative overflow-hidden flex items-center justify-center">
          ...
          <div className="hidden lg:flex flex-1 flex-col justify-center items-start">
            <div className="space-y-8">
              <div className="flex items-center gap-3">
                ...
                <span className="text-2xl font-bold bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">BookMyEvent</span>
              </div>
        ...
        Forgot?
                  ...
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-sm">
                      <span className="px-4 bg-slate-800/40 text-slate-500">New to BookMyEvent?</span>
                    </div>
                  </div>
      ...
      <div className="lg:hidden absolute top-8 left-8 flex items-center gap-2">
        ...
        <span className="text-xl font-bold bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">BookMYShow</span>
      </div>
    </div>
  );
}