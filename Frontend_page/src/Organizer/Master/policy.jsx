            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="col-span-2">
                  <label className="text-sm text-gray-600">Policy Group</label>
                  <select
                    name="policy_group"
                    onChange={handleChange}
                    className="w-full mt-1 p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none"
        ...
        <div className="fixed inset-0 bg-black/70 flex justify-center items-center">
          <div className="bg-white w-[700px] p-6 rounded">
            ...
            <div className="space-y-3">
              <p>
                <b>Name:</b> {viewData.policy_name}
              </p>
              <p>
                <b>Type:</b> {viewData.policy_type}
              </p>
              <p>
                <b>Group:</b> {viewData.policy_group}
              </p>
              <p>
